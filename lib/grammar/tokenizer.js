...
CodeMirror.defineMode("shapeMap", function(config, parserConfig) {
 // var indentUnit = config.indentUnit;
  ...
  var S_TOKEN = 's|S';
  var T_TOKEN = 't|T';
  var A_STRING_TOKEN = 'a|A';
  var R_TOKEN = 'r|R';
  var AT_START = "@"+'('+S_TOKEN+')('+T_TOKEN+')('+A_STRING_TOKEN+')('+R_TOKEN+')('+T_TOKEN+')'; 
  var AT_IRI_REF = "@"+IRI_REF;
  ...
  var terminals = [
    ...
    {
      name: "AT_START",
      regex: new RegExp("^" + AT_START),
      style: "at"
    },

    {
      name: "AT_IRI_REF",
      regex: new RegExp("^" + AT_IRI_REF),
      style: "at"
    },
...
CodeMirror.defineMIME("application/x-shapeMap", "shapeMap");
