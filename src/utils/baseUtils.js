...
var getPersistencyId = function(yasme, persistentIdCreator) {
  ...
  if (persistentIdCreator) {
    if (typeof persistentIdCreator == "string") {
      ...
      persistencyId = persistentIdCreator(yasme);
    }
  }
...
var getString = function(yasme, item) {
...
var readFile = function handleFileSelect(yasme,evt) {
  ...
  reader.onload = function(event) {
    ...
    yasme.setValue(event.target.result)
  };

  reader.readAsText(file);
  Codemirror.signal(yasme,'upload');
}
