...
var getEndPoint = function(yasme,prefixName){

    let definedPrefixex = yasme.getDefinedPrefixes();
    let endpoint = null;
...
var isWikidataEntitiesPrefix = function(yasme,prefixName){

    var definedPrefixex = yasme.getDefinedPrefixes()
    var iriPrefix
...
var isWikidataPropertiesPrefix = function(yasme,prefixName){
